  ...
  return (
    <header className="px-6 py-4 bg-white dark:bg-dark-card sticky top-0 z-40 border-b border-border dark:border-dark-border transition-colors duration-300">
      <div className="relative flex items-center justify-center min-h-[40px]">
        {/* Tombol Hamburger - DIPAKSA KE KIRI */}
        {activeTab !== 'quiz' && (
        ...
        {/* Label Kuis - DIPAKSA KE KANAN */}
        {activeTab === 'quiz' && (
          <div className="absolute right-0 text-[10px] font-bold text-primary dark:text-emerald-400 bg-primary-light dark:bg-emerald-950 px-2 py-1 rounded">
            KUIS
          </div>
        )}
      </div>
